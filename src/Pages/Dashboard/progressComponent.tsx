...
function ProgressBar() {
  const percentage = 66;
  return (
    <div className="flex bg-white mr-[3%] my-[3%] rounded-lg shadow-xl w-fit p-[2%] ">
      <div className="w-full justify-center items-center">
        <p className="text-[18px] text-TK-text my-[2%] ">Survey Engagement</p>
        <strong className="text-[1.776em] my-[3.5%]">232</strong>
